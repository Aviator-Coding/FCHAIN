...
RESOURCES += src/qt/fchain.qrc src/qt/fchain_locale.qrc

TRANSLATIONS += src/qt/locale/fchain_bg.ts \
                src/qt/locale/fchain_de.ts \
                src/qt/locale/fchain_en.ts \
                src/qt/locale/fchain_es.ts \
                src/qt/locale/fchain_fi.ts \
                src/qt/locale/fchain_fr.ts \
                src/qt/locale/fchain_it.ts \
                src/qt/locale/fchain_ja.ts \
                src/qt/locale/fchain_pl.ts \
                src/qt/locale/fchain_pt.ts \
                src/qt/locale/fchain_ru.ts \
                src/qt/locale/fchain_sk.ts \
                src/qt/locale/fchain_sv.ts \
                src/qt/locale/fchain_vi.ts \
                src/qt/locale/fchain_zh_CN.ts \
                src/qt/locale/fchain_zh_TW.ts
