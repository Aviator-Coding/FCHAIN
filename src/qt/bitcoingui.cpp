                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FCHAIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fchain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about FChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FCHAIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FCHAIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a fchain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FChain Core help message to get a list with possible FChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FChain network", "", count));
}
...
{
    QString strTitle = tr("FChain Core"); // default title
