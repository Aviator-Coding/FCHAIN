...
/** Utility functions used by the FChain Qt UI.
 */
namespace GUIUtil
{
...
// Render FCHAIN addresses in monospace font
...
// Parse "fchain:" URI into recipient object, return true on successful parsing
