...
int nStakeTargetSpacing = 60 * 2; // FChain: 2 minute blocks during POS (block 1001+)
...
{
    // FChain will hash in the transaction hash and the index number in order to make sure each hash is unique
