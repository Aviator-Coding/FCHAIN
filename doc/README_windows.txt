...
Intro
-----
FChain (FCHAIN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. FChain utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run fchain-qt.exe.

FChain Core is the original FChain client and it builds the backbone of the network.
However, it downloads and stores the entire history of FChain transactions;
