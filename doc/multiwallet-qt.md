...
In order to support loading of multiple wallets in fchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fchain.cpp.
...
Changes to fchain.cpp
----------------------
fchain.cpp is the entry point into fchain-qt, and as such, will require some minor modifications to provide hooks for
