...
#   c) node1 mines 32 blocks, so now node 0 has 500000FCHAIN, node 1 has 4250FCHAIN, node2 has none.
#   d) node0 sends 601 FCHAIN to node2, in two transactions (301 FCHAIN, then 300 FCHAIN).
