Contributing to FChain Core
==================================

The FChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FChain Core project, and is not to be
confused with overall FChain Network Protocol consensus changes.

Whether a pull request is merged into FChain Core rests with the project merge
...
Patches that change FChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the FChain consensus, it must have been
...
The project leader is the release manager for each FChain Core release.
